...
VL_ATTR_COLD void VHighRiscTb_Bus__B2_P2___ctor_var_reset(VHighRiscTb_Bus__B2_P2* vlSelf) {
    ...
    vlSelf->SlaveReadData0 = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 8874514192215088368ull);
    vlSelf->SlaveReadData1 = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 9959525468525140475ull);
    ...
    vlSelf->PortReadData0 = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 17592359766657480795ull);
    vlSelf->PortReadData1 = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 7436875308007036332ull);
    ...
    vlSelf->__Vdly__SlaveReadData0 = 0;
}
