...
#ifndef VERILATED_VHIGHRISCTB_H_
#define VERILATED_VHIGHRISCTB_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VHighRiscTb VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    VHighRiscTb__Syms* const vlSymsp;
  ...
  public:
    ...
    VHighRiscTb___024root* const rootp;
    ...
    explicit VHighRiscTb(VerilatedContext* contextp, const char* name = "TOP");
    explicit VHighRiscTb(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VHighRiscTb();
  private:
    VL_UNCOPYABLE(VHighRiscTb);  ///< Copying not allowed
